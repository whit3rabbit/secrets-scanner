...
# secrets-scanner (Codex Agent Skill)
...
```sh
bash .codex/skills/secrets-scanner/scripts/install.sh
```
...
```sh
bash .codex/skills/secrets-scanner/scripts/uninstall.sh
```
...
1. **Native git hook** (no framework). Run inside the target repo:
   ```sh
   bash .codex/skills/secrets-scanner/scripts/install-git-hook.sh
   ```
   ...
   `bash .codex/skills/secrets-scanner/scripts/uninstall-git-hook.sh`.
...
- Scripts: `.codex/skills/secrets-scanner/scripts/install.sh`, `.codex/skills/secrets-scanner/scripts/uninstall.sh`, `.codex/skills/secrets-scanner/scripts/install-git-hook.sh`, `.codex/skills/secrets-scanner/scripts/uninstall-git-hook.sh`
